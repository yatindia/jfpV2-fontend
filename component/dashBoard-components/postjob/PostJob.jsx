...
import {formPostJob} from './data1'
import cities from './data2.json'
import category from './data2.json'
...
const postJob =async()=>{ 
    ...
    if (validate.valid===true){
        try {
            const res = await axios.post(`https://api.jobsfinderpro.com/job/create`,inputs,{headers:header})
...
const tagAdd = (e) => {
  ...
  return (<><div className={styles.postJob}>
